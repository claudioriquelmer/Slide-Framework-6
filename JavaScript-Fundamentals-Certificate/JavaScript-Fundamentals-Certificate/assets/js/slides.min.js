window.pluginsAttached ? alert("Attention: plugins.js library is attached twice and needs to be removed. The slides.min.js already contains both of scripts.") : window.pluginsAttached = 1,
    ...
    function(a, b, c, d) {
        ...
        f.prototype.init = function() {
            var b = this;
            "" !== this.options.urlCurl && (i.googlePlus = this.options.urlCurl + "?url={url}&type=googlePlus",
            ...
            f.prototype.loadButtons = function() {
                ...
                a(this.element).append('<div class="buttons"></div>'),
                    a.each(b.options.share, function(a, c) {
                        1 == c && (j[a](b),
                        b.options.enableTracking === !0 && k[a]())
                    })
            }
            ,
            f.prototype.getSocialJson = function(b) {
                ...
                this.options.buttons[b].urlCount === !0 && "" !== this.options.buttons[b].url && (e = i[b].replace("{url}", this.options.buttons[b].url)),
            ...
            e = function() {
                function e() {
                    var c = d()
                        , h = l(i);
                    c !== i ? (k(i = c, h),
                        a(b).trigger(f)) : h !== i && (location.href = location.href.replace(/#.*/, "") + h),
                        g = setTimeout(e, a.fn[f].delay)
                }
                var g, h = {}, i = d(), j = function(a) {
                    return a
                }, k = j, l = j;
    ...
    +function() {
        ...
        b.prototype.listen = function() {
            ...
            b.prototype._zoom = function(a) {
                ...
                if (b && "IMG" == b.tagName && !this._body.classList.contains("zoom-overlay-open")) {
                    if (a.metaKey || a.ctrlKey)
                        return window.open(a.target.getAttribute("data-original") || a.target.currentSrc || a.target.src, "_blank");
            ...
            b.prototype._activeZoomClose = function(a) {
                this._activeZoom && (a ? this._activeZoom.dispose() : this._activeZoom.close(),
            ...
            b.prototype._touchMove = function(a) {
                Math.abs(a.touches[0].pageY - this._initialTouchPosition) > 10 && (this._activeZoomClose(),
            ...
            c.prototype.close = function() {
                return this._body.classList.remove("zoom-overlay-open"),
                    ...
                    !1 in document.body.style ? this.dispose() : (i = this.dispose.bind(this),
                        this._targetImage.addEventListener("transitionend", i),
                        void this._targetImage.addEventListener("webkitTransitionEnd", i))
            }
            ,
            c.prototype.dispose = function() {
                this._targetImageWrap && this._targetImageWrap.parentNode && (this._targetImage.classList.remove("zoom-img"),
    ...
    function(a, b) {
        ...
        if (!c.TweenLite) {
                    ...
                    for (this._targets = g = l(b),
                        ...
                        f = g[e],
                            f ? "string" != typeof f ? f.length && f !== a && f[0] && (f[0] === a || f[0].nodeType && f[0].style && !f.nodeType) ? (g.splice(e--, 1),
                                this._targets = g = g.concat(l(f))) : (this._siblings[e] = U(f, this, !1),
                            1 === i && this._siblings[e].length > 1 && W(f, this, null, 1, this._siblings[e])) : (f = g[e--] = F.selector(f),
                            "string" == typeof f && g.splice(e + 1, 1)) : g.splice(e--, 1);
                else
                    this._propLookup = {},
                        this._siblings = U(b, this, !1),
                    1 === i && this._siblings.length > 1 && W(b, this, null, 1, this._siblings);
            ...
            var U = function(a, b, c) {
                ...
                for (f = e.length; --f > -1; )
                    (h = e[f]) === b || h._gc || h._paused || (h._timeline !== b._timeline ? (j = j || X(b, 0, o),
                    0 === X(h, j, o) && (m[n++] = h)) : l >= h._startTime && h._startTime + h.totalDuration() / h._timeScale > l && ((o || !h._initted) && 2e-10 >= l - h._startTime || (m[n++] = h)));
                for (f = n; --f > -1; )
                    if (h = m[f],
            ...
            f._init = function() {
                ...
                f._initProps = function(b, c, d, e) {
                    ...
                    return e && this._kill(e, b) ? this._initProps(b, c, d, e) : this._overwrite > 1 && this._firstPT && d.length > 1 && W(b, this, c, this._overwrite, d) ? (this._kill(c, b),
                ...
                f.render = function(a, b, c) {
                    ...
                    if (a >= i)
                        ...
                        (0 === a || 0 > j || j === k && "isPause" !== this.data) && j !== a && (c = !0,
    ...
    !function(a, b, c) {
        ...
        var a = function() {
            ...
            c.innerHTML = "1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>0",
                c.setAttribute("style", b("font: 100px/1em sans-serif; -webkit-text-size-adjust: none; text-size-adjust: none; height: auto; width: 1em; padding: 0; overflow: visible;"));
            var d = document.createElement("div");
            d.setAttribute("style", b("width:0; height:0; overflow:hidden; visibility:hidden; position: absolute;")),
                d.appendChild(c),
            ...
            var h, i, j, k;
            window.matchMedia ? h = window.matchMedia : (i = document.getElementsByTagName("head")[0],
            ...
            var l = g(c, d, e);
            return k && (i.removeChild(j),
                document.body.removeChild(k)),
                l
        }
            , m = function() {
            var a = b;
            return isNaN(screen.logicalXDPI) || isNaN(screen.systemXDPI) ? window.navigator.msMaxTouchPoints ? a = d : window.chrome && !(window.opera || navigator.userAgent.indexOf(" Opera") >= 0) ? a = e : Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor") > 0 ? a = f : "orientation"in window && "webkitRequestAnimationFrame"in window ? a = g : "webkitRequestAnimationFrame"in window ? a = h : navigator.userAgent.indexOf("Opera") >= 0 ? a = k : window.devicePixelRatio ? a = j : i().zoom > .001 && (a = i) : a = c,
                a
        }();
        return {
            zoom: function() {
...
$(window).on("load", function() {
    ...
    $(document).ready(function() {
        ...
        function b() {
            ...
            window.loadingProgress == window.images && window.progressBar.addClass("loaded")
        }
        function c() {
            $html.addClass("page-loaded"),
                ...
                setTimeout(function() {
                    window.isScroll && (f(),
                        h()),
                        window.isMobile && window.isSimplifiedMobile ? ($(".slide").addClass("selected animate active"),
                            f(),
                            h()) : d(window.stage)
                }, 500)
        }
        function d(a) {
            if (a = parseInt(a),
                ...
                m(),
                    ...
                    i(),
                    window.allowSlide = 1,
                    n.removeClass("sidebarShown lastSlide firstSlide hidePanel-top hidePanel-bottom"),
                0 != window.setStageClasses && (1 === window.stage && n.addClass("firstSlide"),
                window.stages === window.stage && 1 !== window.stages && n.addClass("lastSlide"),
                    n.removeClassByPrefix("stage-").addClass("stage-" + window.stage)),
                    b.hasClass("whiteSlide") ? n.addClass("whiteSlide") : n.removeClass("whiteSlide"),
                d !== a && 0 != window.setStageClasses && (c.removeClass("selected").addClass("active"),
                ...
                window.setHashLink && (b.attr("data-name") || b.attr("id") ? window.location.hash = b.attr("data-name") ? b.attr("data-name") : b.attr("id") : window.location.toString().indexOf("#") > 0 && "file:" !== location.protocol && location.href.split("#")[0] && (history.pushState ? window.history.pushState("", "", location.href.split("#")[0]) : window.location.hash = "")),
                    b.find(".content, .container").scrollTop(0),
                window.loaded && (window.blockScroll = 1,
                    setTimeout(function() {
                        d !== a && (0 === window.animationLoop ? c.removeClass("active") : c.removeClass("active animate")),
                            window.blockScroll = 0
                    }, window.effectSpeed),
        ...
        function e(a) {
            $(".zoom-overlay-open").length > 0 && ($(".zoom-img").click(),
        ...
        function f() {
            ...
            q >= 2 && (m(),
                ...
                $(".slide").each(function(a, b) {
                    var c = $(b)
                        ...
                        , l = !0;
                    0 === e && (l = 0 === a),
                    e + window.windowHeight === window.documentHeight && (l = a === window.stages - 1),
                    0 != window.setStageClasses && (j && l ? (c.prevAll(".slide").addClass("before").removeClass("after"),
                        c.nextAll(".slide").addClass("after").removeClass("before"),
                        c.addClass("selected animate active").removeClass("after before"),
                    window.stage === d + 1 && window.firstTimeTrigger || (window.stage = d + 1,
                        $(window).trigger("slideChange", [window.stage, c]),
                        1 === window.stage ? n.addClass("firstSlide") : n.removeClass("firstSlide"),
                        window.stages === window.stage ? n.addClass("lastSlide") : n.removeClass("lastSlide"),
                        n.removeClassByPrefix("stage-").addClass("stage-" + window.stage),
                        c.hasClass("whiteSlide") ? n.addClass("whiteSlide") : n.removeClass("whiteSlide"),
                    "auto" == window.isAnimated && (window.clearElementAnimation = setTimeout(function() {
                        c.find("[class*='ae-']").addClass("done")
                    }, window.effectSpeed + window.cleanupDelay))),
                    window.firstTimeTrigger || (window.firstTimeTrigger = 1,
                        $(window).trigger("slideChange", [window.stage, c]))) : c.removeClass("selected"),
                        h()),
                    (!window.isMobile || window.isMobile && window.allowParallaxOnMobile) && k > -1 && k < 1 && (c.hasClass("parallax") || c.find(".parallax-element")) && c.find(".parallax-element").each(function() {
                        var a = $(this)
                            , b = parseInt(a.data("parallax-velocity")) ? parseInt(a.data("parallax-velocity")) : 50
                            , c = k * b;
                        b > 100 && (b = 100),
                            a.css("-webkit-transform", "translate3d(0, " + c + "%, 0)").css("transform", "translate3d(0, " + c + "%, 0)")
                    })
                }),
            "animateOnEvent" == window.isAnimated && (window.preload ? window.loaded && $("[class*='ae-']").each(function(a, b) {
                ...
                }) : 1 == window.animationLoop && (g(c) || c.removeClass("done do"))
            }))
        }
        function g(a) {
        ...
        function j(a) {
            if (a = "undefined" != typeof a && a,
                ...
                var b = a ? a : window.popupShown.slice(-1)[0]
                    ...
                    , d = c.find("iframe[src]")
                    , e = c.find("video");
                d.length > 0 && (c.hasClass("autoplay") || c.find("iframe.autoplay").length) && $(d).each(function(a, b) {
                    var c = $(b).attr("src").replace("?autoplay=1", "?").replace("&autoplay=1", "");
                    $(b).attr("src", c)
                }),
                e.length > 0 && $(e).each(function(a, b) {
                    ...
                    setTimeout(function() {
                        if (window.allowSlide = 1,
                            c.removeClass("visible animate active hidePopup").removeAttr("style").find(".done").removeClass("done"),
                            $html.removeClass("popup_" + b),
                            $.isArray(window.popupShown)) {
                            var a = window.popupShown.indexOf(b);
                            a != -1 && window.popupShown.splice(a, 1)
                        }
                        window.popupShown.length <= 0 && ($html.removeClass("popupShown"),
                            window.popupShown = !1)
                    }, 500)
            }
        }
            ...
            "number" == typeof window.dropdownInterval && clearInterval(window.dropdownInterval),
                b ? (k = !1,
                    $(document).mousemove(function(a) {
                        k = !($(a.target).attr("data-dropdown-id") != g && !$(a.target).closest(".dropdownTrigger.hover[data-dropdown-id=" + g + "]").length && !$(a.target).closest(".dropdown[data-dropdown-id=" + g + "]").length);
                    }),
                    window.dropdownInterval = setInterval(function() {
                        k || (m(),
                            clearInterval(window.dropdownInterval))
                    }, 300)) : m(),
                i.indexOf("bottom") != -1 ? (e -= h.outerHeight(),
                    h.removeClass("top").addClass("bottom")) : (e += a.outerHeight(),
                    h.removeClass("bottom").addClass("top")),
                i.indexOf("right") != -1 ? (f = f - h.outerWidth() + a.outerWidth(),
                    h.removeClass("left center").addClass("right")) : i.indexOf("left") != -1 ? h.removeClass("right center").addClass("left") : i.indexOf("center") != -1 && (f = f - h.outerWidth() / 2 + a.outerWidth() / 2,
        ...
        (window.isScroll || window.isSimplifiedMobile && window.isMobile) && $html.addClass("scrollable"),
            ...
            n.hasClass("fast") ? (window.slideSpeed = 700,
                window.cleanupDelay = 1200,
                window.effectSpeed = 800,
                window.scrollSpeed = .35,
                window.effectOffset = 400) : n.hasClass("slow") && (window.slideSpeed = 1400,
        ...
        n.hasClass("noPreload") && (window.preload = 0),
            n.hasClass("animated") ? window.isAnimated = "auto" : n.hasClass("animateOnEvent") && (window.isAnimated = "animateOnEvent",
            window.isMobile && (window.isAnimated = "auto",
                n.removeClass("animateOnEvent").addClass("animated"))),
        window.isSimplifiedMobile && window.isMobile && (window.isAnimated = !1,
            n.removeClass("animated animateOnEvent"),
            $("[class*='ae-']").addClass("done")),
        window.isAnimated || (window.cleanupDelay = 0),
        n.hasClass("smoothScroll") && !window.isMobile && (window.smoothScroll = 1),
            a(),
            ...
            $("*").each(function() {
                var a, b = $(this);
                "none" !== b.css("background-image") ? a = b.css("background-image").replace(/.*\s?url\([\'\"]?/, "").replace(/[\'\"]?\).*/, "") : b.is("img") && (a = b.attr("src")),
        ...
        window.loaded || $(window).on("load", function() {
            c()
        }),
            ...
            window.changeSlide = function(a) {
                if ("increase" === a ? a = window.stage + 1 >= window.stages ? window.stages : window.stage + 1 : "decrease" === a && (a = window.stage - 1 < 1 ? 1 : window.stage - 1),
                window.isMobile && window.isSimplifiedMobile || window.isScroll) {
                    window.stage = a;
                ...
                $("iframe.autoplay").each(function() {
                    var a = $(this).attr("src").replace("?autoplay=1", "?").replace("&autoplay=1", "");
                    $(this).attr("src", a)
                }),
        ...
        $("body").on("touchstart", function(a) {
            ...
            $("body").on("DOMMouseScroll mousewheel scroll touchend", function(a) {
                "touchend" == a.type && (a.deltaY = a.changedTouches[0].clientY - p,
                    a.deltaFactor = 1);
                ...
                if (c) {
                    if (window.isScroll && !window.sidebarShown && !window.popupShown && !window.blockScroll)
                        if (window.smoothScroll && !window.isMobile) {
                            ...
                            window.isWindows || b.scrollTop(i - g);
                    window.isScroll || window.isMobile && window.isSimplifiedMobile || (j > window.windowHeight && ("up" === h && 0 === b.scrollTop() || "down" === h && b.scrollTop() + window.windowHeight >= Math.floor(j / k) ? window.allowSlide = 1 : window.allowSlide = 0,
                    window.panelsToHide && ("down" === h && b.scrollTop() > 0 ? n.addClass("hidePanel-top") : "up" === h && n.removeClass("hidePanel-top"),
                        n.addClass("hidePanel-bottom"),
                        "down" === h && b.scrollTop() + window.windowHeight >= Math.floor(j / k) ? n.removeClass("hidePanel-bottom") : "up" === h && n.addClass("hidePanel-bottom")),
                    window.sidebarShown || window.popupShown || window.blockScroll || (window.smoothScroll ? (g > 1500 && (g = 1500),
                    g < -1e3 && (g = -1500),
                        TweenLite.to(b, .5, {
                            scrollTo: {
                                y: i - g,
                        ...
                        b.scrollTop(i)))),
                    window.allowSlide && c && ("down" == h ? window.collectScrolls = window.collectScrolls + c : window.collectScrolls = window.collectScrolls - c,
                        setTimeout(function() {
                            window.collectScrolls = 0
                        }, 200)),
                    Math.abs(window.collectScrolls) >= l && window.allowSlide && !window.sidebarShown && !window.popupShown && !window.disableOnScroll && (window.collectScrolls = 0,
                    ("down" === h && window.stage !== window.stages || "up" === h && 1 !== window.stage) && 1 !== window.inAction && ("down" === h ? window.changeSlide("increase") : window.changeSlide("decrease"))))
                }
            }),
        ...
        if ($(".mobile .slides:not(.scroll):not(.simplifiedMobile), .slides.desktopSwipe").swipe({
            swipeStatus: function(a, b, c, d) {
                ...
                window.horizontalMode && (g = "left",
                    h = "right"),
                !window.horizontalMode && f > j && (window.scrollTop + j < f && (window.allowSwipeUp = 0),
                window.scrollTop > 0 && (window.allowSwipeDown = 0)),
                window.sidebarShown || window.disableOnSwipe || (window.horizontalMode ? c === g && d > i ? window.changeSlide("increase") : c === h && d > i && window.changeSlide("decrease") : c === g && d > i && window.allowSwipeUp && window.allowSlide ? window.changeSlide("increase") : c === h && d > i && window.allowSwipeDown && window.allowSlide && window.changeSlide("decrease"))
            },
            maxTimeThreshold: 0,
            fingers: "all",
            ...
            $(window).on("load resize ready", function() {
                ...
                if ((window.isMobile || $(document).width() < 767) && f)
                    ...
                    d.children().each(function() {
                        ...
                        g + Math.round(b) > a + 2 || (window.isMobile || a < 767) && f ? ($(d).addClass("hidden"),
                            $(e).removeClass("hidden")) : ($(d).removeClass("hidden"),
                            $(e).addClass("hidden"))
                }
            })
        }),
        $(".panel.hideOnScroll").length > 0 && (window.panelsToHide = !0,
        window.isScroll || window.isSimplifiedMobile)) {
            var r, s = 0, t = window.hideOnScrollSensitivity ? window.hideOnScrollSensitivity : 100, u = $(".panel.hideOnScroll");
            $(window).on("mousewheel", function(a) {
                ...
                s <= t / 5 && (s = 0,
                    c.removeClass("hide"))),
                    r = b,
                (b + window.windowHeight + t >= window.documentHeight || b + t <= 0) && c.removeClass("hide")
            })
        }
        if (window.isMobile) {
            var v = window.isScroll ? $(document) : $(".slide .content")
                , w = (v.find(".container").outerHeight(),
                0)
            ...
            v.on("scroll", function(a) {
                if (!window.inAction) {
                    var b = $(this)
                        , c = $(this).scrollTop()
                        , d = c > w ? "down" : "up";
                    "down" === d && b.scrollTop() > 0 ? (x && n.addClass("hidePanel-top"),
                    y && n.addClass("hidePanel-bottom")) : "up" === d && n.removeClass("hidePanel-top hidePanel-bottom"),
                        w = c
                }
            })
        }
        $(document).on("keydown", function(a) {
            var b = 2.5
                ...
                , f = d.scrollTop()
                , g = f + parseInt(b * c);
            window.disableKeyNavigation || "input" == a.target.nodeName.toLowerCase() || "textarea" == a.target.nodeName.toLowerCase() || (37 !== a.keyCode && 33 !== a.keyCode || (a.preventDefault(),
            window.horizontalMode && window.changeSlide("decrease")),
            38 !== a.keyCode && 33 !== a.keyCode || (window.horizontalMode ? (a.preventDefault(),
                ...
                window.changeSlide("decrease"))),
            39 !== a.keyCode && 34 !== a.keyCode || window.horizontalMode && (a.preventDefault(),
                window.changeSlide("increase")),
            40 !== a.keyCode && 34 !== a.keyCode || (window.horizontalMode ? (a.preventDefault(),
                TweenLite.to(d, window.scrollSpeed, {
                    scrollTo: {
                        y: g,
                        autoKill: !0
        ...
        if ($(A).length > 0 && ($(A).is(":empty") && $(A).each(function(a, b) {
            for (var c = 1; c <= B; c++) {
        ...
        $(".side").hasClass("compact") || $(window).on("load resize ready", function() {
            ...
            $("a[href^='#'][target!='_blank']").click(function(a) {
                ...
                if (e.length > 0) {
                    ...
                    window.isMobile && window.isSimplifiedMobile || window.isScroll) {
                        ...
                        $(this).hasClass("toLastSlide") && $("body").hasClass("lastSlide") || (window.stage = $(".slide").index(e) + 1,
                            d(window.stage));
                    i()
                }
            }),
            ...
            $(document).on("mouseup touchstart", function(a) {
                var b = $(".sidebarShown .sidebar, .dropdownTrigger")
                    , c = a.target;
                !b.is(c) && 0 === b.has(c).length && window.hideSidebarOnBodyClick && $(c).hasClass("ignoreBodyClick") === !1 && i(),
            ...
            $(".popupTrigger[data-popup-id]").on("click", function() {
                ...
                "string" != typeof b && "" != b && (b = !1),
                    window.showPopup(a, b)
            }),
                ...
                if (f.length > 0) {
                    ...
                    j.length > 0 && j.each(function() {
                        var a = $(this)
                            ...
                            , c = b.indexOf("?") > -1 ? "&" : "?";
                        $(f).hasClass("autoplay") || a.hasClass("autoplay") && a.closest(".slider li.selected").length ? (a.attr("allow", "autoplay"),
                            a.attr("src", b + c + "autoplay=1")) : a.attr("src") || a.attr("src", b)
                    }),
                    k.length > 0 && k.each(function() {
                        var a = $(this);
                        a.find("source[data-src]").length > 0 && (a.find("source").each(function() {
                            $(this).attr("src") || $(this).attr("src", $(this).data("src"))
                        }),
                            a[0].load()),
                        ($(f).hasClass("autoplay") || a.hasClass("autoplay") && a.closest(".slider li.selected").length) && a[0].play()
                    })
                }
                m()
            }
            ...
            $(document).on("mousedown", function(a) {
                C = !!$(a.target).closest(".popupShown .popup .popupContent, .popupTrigger").length
            }),
                $(document).on("click", function(a) {
                    var b = $(".popupShown .popup .popupContent, .popupTrigger");
                    !b.is(a.target) && 0 === b.has(a.target).length && b.length > 0 && !C && ($(a.target).closest(".dialog").length && 0 != $(a.target).closest(".popup").length) !== !1 && j()
                })
        }
        ...
        var D = $(".slider")
            ...
            , F = function(a, b) {
            if (a.find(">li iframe").each(function() {
                var a = $(this).attr("src");
                "string" == typeof a && a.indexOf("autoplay") != -1 && (a = a.replace("?autoplay=1", "?").replace("&autoplay=1", ""),
                    $(this).attr("src", a)),
            ...
            0 == a.closest(".popup").length || b) {
                ...
                if (c.length > 0) {
                    var d = c.attr("src") ? c.attr("src") : c.data("src")
                        , e = d.indexOf("?") > -1 ? "&" : "?";
                    d.indexOf("autoplay") == -1 && (c.attr("allow", "autoplay"),
                        c.attr("src", d + e + "autoplay=1"))
                }
                var f = a.find("li.selected video.autoplay");
                f.length > 0 && (f.find("source[data-src]").length > 0 && f.find("source").each(function() {
                    $(this).attr("src") || $(this).attr("src", $(this).data("src"))
                }),
                    f[0].load(),
                    f[0].play())
        ...
        $(D).length > 0 && $(D).each(function(a, b) {
            ...
            if (window.sliderStatus && $html.removeClassByPrefix("slider_" + d).addClass("slider_" + d + "_" + e),
                c.hasClass("autoplay")) {
            ...
            if ((c.hasClass("clickable") || c.hasClass("autoplay") || c.hasClass("swipeable")) && (c.on("next", function(a) {
                var b = $(this)
                    , c = b.data("slider-id")
                ...
                "cancel" != $(f).data("slider-event") && (d.each(function() {
                    ...
                    a.find(">li iframe.autoplay, >li video.autoplay") && F(a, !0),
                    window.sliderStatus && $html.removeClassByPrefix("slider_" + b).addClass("slider_" + b + "_" + e),
                    h && (a.addClass("animateOnEvent"),
            ...
            (c.hasClass("clickable") || c.hasClass("autoplay")) && c.on("click", function() {
                $(this).trigger("next")
            })),
                ...
                c.swipe({
                    swipeStatus: function(a, b, d, e) {
                        "end" == b && e > h && ("right" == d && c.trigger("prev"),
        ...
        var G = $(".controller");
        if (G.length > 0) {
            var H = G.data("controller-selector") ? G.data("controller-selector") : "li";
        ...
        $(document).on("click", "[data-slider-action]", function() {
            if ($(this).data("slider-id")) {
                var a, b, c = $(this), d = c.data("slider-id"), e = c.data("slider-action"), f = $('.slider[data-slider-id="' + d + '"]'), g = $('.controller[data-slider-id="' + d + '"]'), h = $('.sliderCounter[data-slider-id="' + d + '"]');
                window.sliderStatus && $html.removeClassByPrefix("slider_" + d).addClass("slider_" + d + "_" + b),
                    f.each(function() {
                        var c = $(this)
                            , d = (g.data("controller-selector") ? g.data("controller-selector") : "li",
                            c.find(".selected"))
                            , f = c.hasClass("animated");
                        "next" === e ? a = d.nextOrFirst("li") : "prev" === e ? a = d.prevOrLast("li") : (parseInt(e) || 0 === e) && (b = parseInt(e),
                            a = c.find(">li:eq(" + b + ")")),
                            b = a.index(),
                            d.removeClass("selected"),
                            a.removeClass("hide").addClass("selected"),
                        c.find(">li iframe.autoplay, >li video.autoplay") && F(c, !0),
                        f && (c.addClass("animateOnEvent"),
        ...
        $(".share").data("text") && (window.shareText = $(".dropdown").data("url")),
            ...
            $.fn.slidesDialog = function(a) {
                function b(a, b) {
                    var f = c(a);
                    if (a && a.settings && a.settings.template != f.template && ($(a).remove(),
                        a = !1),
                    a || (a = $(f.template),
                ...
                function c(b) {
                    ...
                    if (b) {
                        ...
                        var d = $(b);
                        Object.keys(d.data()).length && (d.attr("data-dialog-id") && (c.id = d.attr("data-dialog-id")),
                        d.attr("data-dialog-action") && (c.action = d.attr("data-dialog-action")),
                        d.attr("data-dialog-speed") && (c.speed = parseInt(d.attr("data-dialog-speed"))),
                        d.attr("data-dialog-open-delay") && (c.openAfter = parseInt(d.attr("data-dialog-open-delay"))),
                        d.attr("data-dialog-close-delay") && (c.closeAfter = parseInt(d.attr("data-dialog-close-delay")))),
                ...
                function d(a) {
                    ...
                    a.open = function(c) {
                        ...
                        a.closeTimeout && clearTimeout(a.closeTimeout),
                            a.openTimeout = setTimeout(function() {
                                $(a).is(":visible") || $(a).addClass("reveal").slideDown(b.speed, function() {
                                    $(this).removeClass("reveal hidden")
                                })
                            }, c ? 0 : b.openAfter),
                        b.closeAfter + b.openAfter > b.openAfter && !c && (a.closeTimeout = setTimeout(function() {
                            a.close()
                        ...
                        a.close = function() {
                            a.openTimeout && clearTimeout(a.openTimeout),
                            a.closeTimeout && clearTimeout(a.closeTimeout),
                            $(a).is(":visible") && $(a).addClass("hide").slideUp(b.speed, function() {
                                $(this).removeClass("hide")
                            })
                        }
                }
                function e(a) {
                    $(a).click(function() {
                        ...
                        "" != b && void 0 != b || (b = !1),
                            "close" == a ? b && 0 == $(this).closest(".dialog").length ? $(document).find(".dialog[data-dialog-id=" + b + "]").slidesDialog("close") : $(this).closest(".dialog").slidesDialog("close") : (a = b) && $(document).find(".dialog[data-dialog-id=" + b + "]").slidesDialog("open")
                    })
                }
                if (0 == $(document).find(".dialogContainer").length)
                    return !1;
                if ("bindOpenCloseMethods" == a)
                    return e($(this)),
                        !1;
                var f = this;
                if (0 == f.length) {
                    if (!a.id)
                        return alert("Error: you need to provide the 'id' property to create a dialog!"),
                            !1;
                    f = $(document).find(".dialog[data-dialog-id=" + a.id + "]")
                }
                f.length ? f.each(function(c, d) {
                    "string" != typeof a ? b(d, a) : ("open" == a && d.open(!0),
                    "close" == a && d.close())
                }) : b(!1, a)
            }
            ,
            ...
            $(".soundTrigger").click(function() {
                ...
                !b[0].paused || "toggle" !== c && "play" !== c ? "toggle" !== c && "pause" !== c || (b.animate({
                    ...
                    $(this).removeClass("playing")) : (b[0].play(),
                    b.animate({
                        volume: 1
                    }, d),
